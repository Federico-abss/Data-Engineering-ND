...
def main():
    ...
    - Populates the artists and songs tables with the song_data informations.
    
    - Populates the time, users and songplays tables with the log_data informations.
    
    - Keeps track of the progress in the terminal
